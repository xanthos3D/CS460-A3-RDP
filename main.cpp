...
1. g++ main.cpp Token.cpp Tokenizer.cpp Parser.cpp
2. ./a.out programming_assignment_3-test_file_1.c
...
results for the input test files I have provided below. You are not required to
generate PDF output or use fancy graphics output of any kind for this assignment.
*********************************************************************** */
#include <iostream>
#include <fstream>
#include<stack>
